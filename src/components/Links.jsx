...
export default function Links() {
  return (
        <div className='text-white grid grid-cols-4 gap-6 flex flex-row justify-center items-center'>
            ...
            <a href='https://www.soundcloud.com/' target="_blank"><SiSoundcloud size={45} className="text-orange-600 cursor-pointer hover:scale-110 duration-100"/></a>
            ...
            <a href='https://www.github.com/' target="_blank"><SiGithub size={35} className="text-slate-400 cursor-pointer hover:scale-110 duration-100"/></a>
